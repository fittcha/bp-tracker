...
-- 기존 8주 프로그램 시드(하루=1카드) 제거 후 섹션=별도 카드로 재적용. exercises는 cascade 삭제.
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'Banded Strict Chest to bar', '8', '이중 점진', 0, 1, 'Superset · 3 Sets'),
  ('B', 'Single Arm DB Row', '12/12', '이중 점진', 1, 1, 'Superset · 3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'Plank Shoulder Taps', '0:30', '전거근', 0, 1, '2 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('A', 'DB Hex Press', '8', '이중 점진', 0, 1, '4 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
select w.id, v.* from w, (values
  ...
  ('B', 'Close-grip Push up', '10~15', null, 1, 1, 'Superset · 3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'Side Plank Hip Touch', '10/10', '항회전 코어', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('D', 'Toes to bar', '8', '벅차면 Knee Raises 10개 · 오늘의 피니셔', 0, 1, 'EMOM 8분')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'Single Arm DB Row', '12/12', '이중 점진', 0, 1, 'Superset · 3 Sets'),
  ('B', 'Banded Face Pull', '20', '이중 점진', 1, 1, 'Superset · 3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'Hollow Rock Hold', '0:20', '코어', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('A', 'Bulgarian Split Squat', '8/8', '이중 점진', 0, 1, '4 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('D', 'Side V ups', '12/12', '코어', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'Banded Strict Pull up', '8', '이중 점진', 0, 1, 'Superset · 3 Sets'),
  ('B', 'Barbell Curl', '10', '이중 점진', 1, 1, 'Superset · 3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
select w.id, v.* from w, (values
  ('B', 'Banded Strict Pull up', '8', '이중 점진', 0, 1, 'Superset · 3 Sets'),
  ('B', 'Pendlay Row', '8', '이중 점진', 1, 1, 'Superset · 3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'Serratus Punch (band)', '12', '전거근', 0, 1, '2 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'Pallof Press', '10/10', '항회전 코어', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('D', 'DB Arnold Press', null, '무게↑ · 오늘의 피니셔', 0, 1, 'Climbing 12-10-8-6')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'DB Bent Over Row', '10', '이중 점진', 0, 1, 'Superset · 3 Sets'),
  ('B', 'Banded Face Pull', '20', '이중 점진', 1, 1, 'Superset · 3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'Hollow Rock Hold', '0:25', '코어', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('A', 'Barbell Overhead Press (밀리터리)', '5', '그 주 강도 · 3~4개 남기기', 0, 1, '4 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('D', 'Russian Twist', '24', '코어', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
select w.id, v.* from w, (values
  ('B', 'Single Arm DB Row', '12/12', '이중 점진', 0, 1, 'Superset · 3 Sets'),
  ('B', 'Seated DB Curl', '12', '이중 점진', 1, 1, 'Superset · 3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'Serratus Punch (band)', '0:30', '전거근', 0, 1, '2 Sets'),
  ('C', 'V ups', '15', '코어', 1, 1, '2 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'Banded Lat Pulldown', '12', '이중 점진', 0, 1, 'Superset · 3 Sets'),
  ('B', 'DB Bent Over Row', '10', '이중 점진', 1, 1, 'Superset · 3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'Feet Elevated Push ups', '10', '전거근', 0, 1, '2 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('A', 'DB Hex Press', '10', '이중 점진', 0, 1, '4 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'Plank Pull Through', '24', '항회전 코어', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('D', 'Toes to bar + Push ups', null, '오늘의 피니셔', 0, 1, '21-15-9 For time')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'Banded Bent Over Row', '12', '이중 점진', 0, 1, 'Superset · 3 Sets'),
  ('B', 'Banded Face Pull', '20', '이중 점진', 1, 1, 'Superset · 3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('A', 'DB Reverse Lunge', '10/10', '이중 점진', 0, 1, '4 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
select w.id, v.* from w, (values
  ('B', 'Banded Lat Pulldown', '12', '이중 점진', 0, 1, 'Superset · 3 Sets'),
  ('B', 'Hammer Curl', '12', '이중 점진', 1, 1, 'Superset · 3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'Feet Elevated Push ups', '0:30', '전거근', 0, 1, '2 Sets'),
  ('C', 'Hollow Rock', '15', '코어', 1, 1, '2 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'Banded Strict Chest to bar', '8', '이중 점진', 0, 1, 'Superset · 2 Sets'),
  ('B', 'Banded Face Pull', '20', '이중 점진', 1, 1, 'Superset · 2 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('A', 'DB Hex Press', '10', '가볍게 · 이중 점진', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'Bar/Box Dips', '10', null, 0, 1, 'Superset · 2 Sets'),
  ('B', 'Close-grip Push up', '12', null, 1, 1, 'Superset · 2 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'DB Side Bend', '12/12', '항회전 코어', 0, 1, '2 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('D', 'DB Lateral Raise', '15', '디로드, 가볍게 · 오늘의 피니셔', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'Single Arm DB Row', '12/12', '이중 점진', 0, 1, 'Superset · 2 Sets'),
  ('B', 'Band Pull Aparts', '20', '이중 점진', 1, 1, 'Superset · 2 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'Hollow Rock Hold', '0:20', '코어', 0, 1, '2 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('A', 'Barbell Overhead Press (밀리터리)', '5', '디로드, 가볍게 · 6개+ 남기기', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'Banded Strict Pull up', '8', '이중 점진', 0, 1, 'Superset · 2 Sets'),
  ('B', 'Barbell Curl', '10', '이중 점진', 1, 1, 'Superset · 2 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'DB Pullover', '12', '전거근', 0, 1, '2 Sets'),
  ('C', 'V ups', '12', '코어', 1, 1, '2 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
select w.id, v.* from w, (values
  ('B', 'Banded Strict Pull up', '8', '이중 점진', 0, 1, 'Superset · 3 Sets'),
  ('B', 'KB Gorilla Row', '10/10', '이중 점진', 1, 1, 'Superset · 3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'Single Arm Waiter Hold', '0:30/0:30', '항회전 코어', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('D', 'DB Bent Row + DB Arnold Press', null, '오늘의 피니셔', 0, 1, '20-18-16-14-12-10')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'Pendlay Row', '8', '이중 점진', 0, 1, 'Superset · 3 Sets'),
  ('B', 'Banded Face Pull', '20', '이중 점진', 1, 1, 'Superset · 3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('A', 'Barbell Back Rack Lunge', '8/8', '이중 점진', 0, 1, '4 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'Plank Bird Dog', '10/10', '항회전 코어', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('D', 'Burpee', '100', '도전 주간 · 오늘의 피니셔', 0, 1, '100 reps For time')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'KB Gorilla Row', '10/10', '이중 점진', 0, 1, 'Superset · 3 Sets'),
  ('B', 'Band Pull Aparts', '20', '이중 점진', 1, 1, 'Superset · 3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('A', 'Barbell Overhead Press (밀리터리)', '3', '그 주 강도 · 1~2개 남기기', 0, 1, '4 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'Banded Strict Pull up', '8', '이중 점진', 0, 1, 'Superset · 2~3 Sets'),
  ('B', 'Pendlay Row', '8', '이중 점진', 1, 1, 'Superset · 2~3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('A', 'DB Hex Press', '8', '이중 점진', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'Bar/Box Dips', '8~12', null, 0, 1, 'Superset · 2~3 Sets'),
  ('B', 'Close-grip Push up', '10~15', null, 1, 1, 'Superset · 2~3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'Band Wood Chop', '12/12', '항회전 코어', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('D', 'DB Bent Row', null, '무게↑ · 오늘의 피니셔', 0, 1, 'Climbing 10-8-6-4-2')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'DB Bent Over Row', '10', '이중 점진', 0, 1, 'Superset · 2~3 Sets'),
  ('B', 'Banded Face Pull', '20', '이중 점진', 1, 1, 'Superset · 2~3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('A', 'Bulgarian Split Squat', '8/8', '이중 점진', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'Pendlay Row', '8', '이중 점진', 0, 1, 'Superset · 2~3 Sets'),
  ('B', 'Barbell Curl', '10', '이중 점진', 1, 1, 'Superset · 2~3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'Single Arm DB Row', '12/12', '이중 점진', 0, 1, 'Superset · 2~3 Sets'),
  ('B', 'Banded Lat Pulldown', '12', '이중 점진', 1, 1, 'Superset · 2~3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('A', 'DB Hex Press', '8', '가볍게 · 이중 점진', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('B', 'Bar/Box Dips', '10', null, 0, 1, 'Superset · 2~3 Sets'),
  ('B', 'Close-grip Push up', '12', null, 1, 1, 'Superset · 2~3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('C', 'Side Plank Hip Touch', '10/10', '항회전 코어', 0, 1, '2 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('D', 'Toes to bar + Sit ups', null, 'T2B 8개 + Sit ups 15개 번갈아 · 오늘의 피니셔', 0, 1, 'EMOM 8분')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
select w.id, v.* from w, (values
  ('B', 'Single Arm DB Row', '12/12', '이중 점진', 0, 1, 'Superset · 2~3 Sets'),
  ('B', 'Band Pull Aparts', '20', '이중 점진', 1, 1, 'Superset · 2~3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
insert into workout_exercises (workout_id, section, exercise_name, reps, notes, sort_order, set_group, set_info)
select w.id, v.* from w, (values
  ('A', 'Barbell Overhead Press (밀리터리)', '5', '가볍게, 기술 위주 (금 벤치 1RM 보호)', 0, 1, '3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
...
select w.id, v.* from w, (values
  ('B', 'Banded Strict Pull up', '8', '이중 점진', 0, 1, 'Superset · 2~3 Sets'),
  ('B', 'Hammer Curl', '12', '이중 점진', 1, 1, 'Superset · 2~3 Sets')
) as v(section, exercise_name, reps, notes, sort_order, set_group, set_info);
