            ...
            >
              <div className="flex items-start justify-between gap-2">
                ...
                <div className="flex items-center gap-0.5 shrink-0">
                  <Flame size={15} className={w.streak.alive ? 'text-[#F97316]' : 'text-text-secondary/40'} />
                  <span className={`text-sm font-bold tabular-nums ${w.streak.alive ? 'text-[#F97316]' : 'text-text-secondary'}`}>{w.streak.count}</span>
                </div>
              </div>
